			...
			<div class="row">
				<div class="responsive-theme-feature-cards upgrade-to-pro-card">
				    <div class="responsive-theme-feature-cards-content">
						...
						<button class="btn-upgrade" onclick="window.open('<?php echo esc_url('https://cyberchimps.com/pricing/?utm_source=wpdash&utm_medium=RST_plugin&utm_campaign=intro_banner&utm_content=upgrade-to-pro'); ?>', '_blank')"><?php esc_html_e('Upgrade', 'responsive'); ?></button>
					</div>
				</div>
			</div>
			<hr>
